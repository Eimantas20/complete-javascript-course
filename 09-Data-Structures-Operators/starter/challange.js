...
const button = document
    ...
    .addEventListener('click', convertCamelCase);
...
const formatDestinationLocation = str => str.slice(0, 3).toUpperCase();

const flights =
    '_Delayed_Departure;fao93766109;txl2133758440;11:25+_Arrival;bru0943384722;fao93766109;11:45+_Delayed_Arrival;hel7439299980;fao93766109;12:05+_Departure;fao93766109;lis2323639855;12:30';

for (const infoBlock of flights.split('+')) {
    const [type, location, destination, time] = infoBlock.split(';');
    const output = `${type.startsWith('_Delayed') ? '+' : ''} ${type.replaceAll(
        '_',
        ' '
    )} from ${formatDestinationLocation(
        location
    )} to ${formatDestinationLocation(destination)} (${time.replace(
        ':',
        'h'
    )})`.padStart(44);
    console.log(output);
}
// convertCamelCase('first_name');
...
// console.log(
//     `An event happened, on avererage, every ${time / gameEvents.size} minutes`
// );
...
//     console.log(
//         `[${
//             time <= 45 ? 'FIRST HALF' : time >= 90 ? 'EXTRA' : 'SECOND HALF'
//         }] ${time}: ${event}`
//     );
// }
...
//     console.log(`The ${player} hit the ${i + 1} goal in a game`);
// }
